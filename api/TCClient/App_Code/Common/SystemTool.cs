...
namespace Com.Caimomo.Common
{
    public class SystemTool
    {
        ...
        {
            using (EasyDataContext context = MyDataContextFactory.GetDataContext<EasyDataContext>(groupid))
            {
                ...
                {
                    using (EasyDataContext ccontext = MyDataContextFactory.GetDataContext<EasyDataContext>(MyDataContextFactory.CanYinCenter))
                    {
        ...
        {
            using (EasyDataContext context = MyDataContextFactory.GetDataContext<EasyDataContext>(Security.CurrentUser.GroupID))
            {
